...
const Login = () => {
  ...
  return (
    <div>
      ...
      <form className="absolute p-12 bg-black my-36 mx-auto right-0 left-0 w-3/12 text-white flex flex-col items-center rounded-3xl bg-opacity-80" onSubmit={(e)=>e.preventDefault()}>
        ...
        <button className="p-3 m-3 bg-red-700 w-full rounded-xl font-bold"
